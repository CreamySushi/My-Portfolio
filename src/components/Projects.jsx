...
const Projects = () => {
  const myProjects = [
    ...
    {
      id: 3, srcImg: focusTaskApp, title: "Focus-Task", tools: ['React', 'JavaScript', 'TailwindCSS', 'HTML'],
      description: "Focus-Task is a simple and modern to-do application designed to help users organize their daily tasks efficiently. It allows users to add, view, and manage tasks with details such as title, description, deadline, and time. ", link: "https://focus-task-theta.vercel.app/"
    },
  ]
